...
const navItems = [
  ...
  { href: '/invoices/history', label: 'Automation History', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
]
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white min-h-screen p-4">
      <div className="mb-8">
        <h1 className="text-xl font-bold">AutomatePOS</h1>
        <p className="text-gray-400 text-sm">Back Office Automation</p>
      </div>
